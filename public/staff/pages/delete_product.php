...
<div class="Page delete">
   ...
   <p><?php echo h($product['product_name']); ?></p>
   
   <form action="<?php echo url_for('/staff/pages/delete_product.php?id= ' . h(u($product['product_id'])));?>" method="post">
    

    <div class="form-group">
    <input class="btn btn-success" type="submit" name="submit" value="Delete product">
